...
* Build the application by running the `mvn package` maven command at the "webservice-registry" project root folder	on the terminal.
* If you want to run the application as jar file, then run `java -jar target/registry-service.jar` command at the terminal.
